...
export default function ProfessionalDashboard() {
  ...
  const latestData = currentPerformanceData.find((item) => item.year === "2025 Fall")
  ...
  const previousValue = currentPerformanceData.find((item) => item.year === "2025 Spring")?.conway || 0
          ...
          <div className="flex items-start justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-blue-200 text-sm">
                Historical Analysis (2023 Spring - 2025 Fall)
              </p>
            </div>
            <div className="text-right">
              <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg px-4 py-2 border border-white border-opacity-30">
                ...
                <div className="text-white text-sm font-semibold">November 2025</div>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-baseline gap-3">
                      ...
                      <span className="text-gray-500 text-sm">Fall 2025</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="border-t pt-6">
                ...
                <div className="flex items-center justify-between gap-2 sm:gap-4">
                  ...
                  <div className="flex flex-col items-center flex-1">
                    ...
                    <div className="text-xs text-center text-gray-600 font-medium">Spring<br/>2025</div>
                  </div>
                  ...
                  <div className="flex flex-col items-center flex-1">
                    ...
                    <div className="text-xs text-center font-semibold" style={{ color: "#ffc107" }}>Fall<br/>2025</div>
                  </div>
                </div>
                ...
                <div className="mt-6 grid grid-cols-3 gap-4">
                  <div className="text-center p-3 rounded-lg" style={{ backgroundColor: "#f8fafc" }}>
                    ...
                    <div className="text-xl font-bold" style={{ color: "#ffc107" }}>B-</div>
                  </div>
                  <div className="text-center p-3 rounded-lg" style={{ backgroundColor: "#f8fafc" }}>
                    <div className="text-xs text-gray-600 mb-1">Grade History</div>
                    <div className="text-sm font-semibold text-gray-700">3 B's, 3 C's</div>
                  </div>
                  <div className="text-center p-3 rounded-lg" style={{ backgroundColor: "#f8fafc" }}>
              ...
              <CardContent className="pt-6">
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="text-center p-4 rounded-lg" style={{ backgroundColor: "#F8FAFC" }}>
                    ...
                    <div className="text-xs text-gray-500 mt-1">2025 Fall</div>
                  </div>
                  <div className="text-center p-4 rounded-lg" style={{ backgroundColor: "#F8FAFC" }}>
